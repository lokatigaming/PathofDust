...
pub enum Store {
    ...
    RefundReforgeNowOverchargeMarker,
...
impl Store {
    ...
    Store::RefundReforgeNowOverchargeMarker,
    ...
    pub const fn name(self) -> &'static str {
        match self {
            ...
            Store::RefundReforgeNowOverchargeMarker => "adventure-refund-reforge-now-overcharge-marker.json",
    ...
    pub const fn scope(self) -> StoreScope {
        match self {
            ...
            Store::RefundReforgeNowOverchargeMarker => StoreScope::World,
    ...
    pub const fn kind(self) -> StoreKind {
        match self {
            ...
            Store::RefundReforgeNowOverchargeMarker => StoreKind::File,
    ...
    pub const fn why(self) -> &'static str {
        match self {
            ...
            Store::RefundReforgeNowOverchargeMarker => "one-time migration marker - records that a backfill already ran against THIS world's characters",
