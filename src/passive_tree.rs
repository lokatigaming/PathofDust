...
static WARLOCK_NODES: &[PassiveNode] = &[
    ...
    spec("doom", "curse", "Doom", "Curse of Weakness detonates for a burst of damage when it expires, equal to 20% of damage dealt to the cursed target per rank (up to 60% at 3/3).", Special { at_rank_1: 0.20, per_additional_rank: 0.20 }),
